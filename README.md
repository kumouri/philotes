# multiplayer-matchmaking (working name)

Group matchmaking for multiplayer games in which friendships form as a side effect.
...
**Status: specced, unbuilt.** Nothing here runs yet. The name is still an open question.
